  ...
  return (
    <section id="prizes" className="relative py-10 md:py-20">
      ...
      <div className="container mx-auto px-4 relative z-10 space-y-2 md:space-y-4">
        ...
        <p className="text-sm md:text-xl xl:text-xl text-gray-400 text-center lg:max-w-6xl sm:max-w-[calc(100%-7rem)] max-w-[calc(100%-.5rem)] mx-auto mb-6 md:mb-16">
          {t('subtitle')}
        </p>

        <div className="flex items-center justify-center md:gap-[2.5%] gap-2 mb-6 md:mb-12 lg:max-w-6xl 
          ...
          {CONFIG.prizes.topPrizes.map((prize, i) => (
            <div key={prize.place}
              ...
              <div className={`2xl:px-16 md:px-4 p-2 text-center flex items-center justify-center flex-col size-full gap-1 md:gap-3`}>
                <div className={`inline-flex items-center justify-center xl:size-26 lg:size-20 size-8 rounded-full mb-1`}
                  style={{background: prize.iconBg, boxShadow: prize.iconShadow}}>
                  <Image src={prize.icon} alt={t(prize.key)} width={48} height={48} className="xl:size-16 lg:size-12 size-6 object-contain"/>
                </div>
                ...
                <p className="text-sm md:text-3xl lg:text-5xl font-bold bg-clip-text text-transparent"
        ...
        <div className="grid grid-cols-2 md:gap-6 gap-2 mb-8 md:mb-16 lg:max-w-6xl sm:max-w-[calc(100%-7rem)] max-w-[calc(100%-.5rem)]  mx-auto">
        ...
        <div className="lg:max-w-6xl sm:max-w-[calc(100%-7rem)] max-w-[calc(100%-.5rem)]  mx-auto">
